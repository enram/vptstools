...
class TestOdimFilePath:
    ...
    @pytest.mark.parametrize(
        ...
        [("baltrad/hdf5/fivan/2016/10/25/fivan_vp_20161025T2100Z_0x7_147742969449.h5",
          ("fivan", "vp", "2016", "10", "25", "21", "00", "fivan_vp_20161025T2100Z_0x7_147742969449.h5")),
         ("baltrad/hdf5/fiuta/2021/11/14/fiuta_vp_20211114T214500Z_0xb.h5",
          ("fiuta", "vp", "2021", "11", "14", "21", "45", "fiuta_vp_20211114T214500Z_0xb.h5")),
         ("baltrad/hdf5/seang/2017/01/20/seang_vp_20170120T2115Z_0xf3fc7b_148494821853.h5",
          ("seang", "vp", "2017", "01", "20", "21", "15", "seang_vp_20170120T2115Z_0xf3fc7b_148494821853.h5")),
         ("baltrad/hdf5/searl/2016/12/31/searl_vp_20161231T2030Z_0x5_148321870475.h5",
          ("searl", "vp", "2016", "12", "31", "20", "30", "searl_vp_20161231T2030Z_0x5_148321870475.h5")),
         ("baltrad/hdf5/plrze/2020/10/27/plrze_vp_20201027T172000Z_0x9.h5",
          ("plrze", "vp", "2020", "10", "27", "17", "20", "plrze_vp_20201027T172000Z_0x9.h5")),
         ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [("fivan_vp_20161025T2100Z_0x7_147742969449.h5",
          ("baltrad", "fivan", "vp", "2016", "10", "25", "21", "00",
           "fivan_vp_20161025T2100Z_0x7_147742969449.h5", "")),
         ("fiuta_vp_20211114T214500Z_0xb.h5",
          ("baltrad", "fiuta", "vp", "2021", "11", "14", "21", "45",
           "fiuta_vp_20211114T214500Z_0xb.h5", "")),
         ("seang_vp_20170120T2115Z_0xf3fc7b_148494821853.h5",
          ("baltrad", "seang", "vp", "2017", "01", "20", "21", "15",
           "seang_vp_20170120T2115Z_0xf3fc7b_148494821853.h5", "")),
         ("searl_vp_20161231T2030Z_0x5_148321870475.h5",
          ("baltrad", "searl", "vp", "2016", "12", "31", "20", "30",
           "searl_vp_20161231T2030Z_0x5_148321870475.h5", "")),
         ("plrze_vp_20201027T172000Z_0x9.h5",
          ("baltrad", "plrze", "vp", "2020", "10", "27", "17", "20",
           "plrze_vp_20201027T172000Z_0x9.h5", "")),
         ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [("baltrad/hdf5/fivan/2016/10/25/fivan_vp_20161025T2100Z_0x7_147742969449.h5",
          ("baltrad", "fivan", "vp", "2016", "10", "25", "21", "00",
           "fivan_vp_20161025T2100Z_0x7_147742969449.h5", "hdf5")),
         ("baltrad/hdf5/fiuta/2021/11/14/fiuta_vp_20211114T214500Z_0xb.h5",
          ("baltrad", "fiuta", "vp", "2021", "11", "14", "21", "45",
           "fiuta_vp_20211114T214500Z_0xb.h5", "hdf5")),
         ("baltrad/hdf5/seang/2017/01/20/seang_vp_20170120T2115Z_0xf3fc7b_148494821853.h5",
          ("baltrad", "seang", "vp", "2017", "01", "20", "21", "15",
           "seang_vp_20170120T2115Z_0xf3fc7b_148494821853.h5", "hdf5")),
         ("baltrad/hdf5/searl/2016/12/31/searl_vp_20161231T2030Z_0x5_148321870475.h5",
          ("baltrad", "searl", "vp", "2016", "12", "31", "20", "30",
           "searl_vp_20161231T2030Z_0x5_148321870475.h5", "hdf5")),
         ("baltrad/hdf5/plrze/2020/10/27/plrze_vp_20201027T172000Z_0x9.h5",
          ("baltrad", "plrze", "vp", "2020", "10", "27", "17", "20",
           "plrze_vp_20201027T172000Z_0x9.h5", "hdf5")),
         ("ecog-04003/hdf5/bgvar/2016/10/02/bgvar_vp_20161002T2345Z.h5",
          ("ecog-04003", "bgvar", "vp", "2016", "10", "02", "23", "45",
           "bgvar_vp_20161002T2345Z.h5", "hdf5"))
         ],
    )
    def test_parse_file_from_inventory(self, file_path, components):
        ...
        source, radar_code, file_type, year, month, day, hour, minute, file_name, file_type = components
        assert odim_path.daily_vpts_file_name == f"{radar_code}_vpts_{year}{month}{day}.csv"
        assert odim_path.s3_path_setup(file_type) == f"{source}/{file_type}/{radar_code}/{year}"
        bucket = "aloft"
        assert odim_path.s3_url_h5(bucket) == f"s3://{bucket}/{source}/{file_type}/{radar_code}/" \
                                              f"{year}/{month}/{day}/{file_name}"
        assert odim_path.s3_folder_path_h5 == f"{source}/{file_type}/{radar_code}/{year}/{month}/{day}"
        assert odim_path.s3_file_path_daily_vpts == f"{source}/daily/{radar_code}/{year}/" \
                                                    f"{radar_code}_vpts_{year}{month}{day}.csv"
        assert odim_path.s3_file_path_monthly_vpts == f"{source}/monthly/{radar_code}/{year}/" \
