...
def vp_metadata_only():
    ...
    return BirdProfile(
        ...
        how={'beamwidth': 1.200000029057264, 'clutterMap': b'', 'comment': b'', 'dealiased': 1, 'enddate': b'20221114',
             ...
             'maxazim': 360.0, 'maxrange': 35.0, 'minazim': 0.0, 'minrange': 5.0, 'rcs_bird': 11.0,
             'sd_vvp_thresh': 2.0, 'software': b'BALTRAD', 'startdate': b'20221114', 'starttime': b'190507',
             'task': b'vol2bird', 'task_args': b'azimMax=360.000000,azimMin=0.000000,layerThickness=200.000000,'
                                               ...
                                               b'vradMin=1.000000',
             'task_version': b'0.5.0.9187', 'vcp': 0, 'wavelength': 5.300000190734863},
        levels=[0, 200, 400, 600, 800, 1000, 1200, 1400, 1600, 1800, 2000, 2200, 2400, 2600, 2800, 3000, 3200,
